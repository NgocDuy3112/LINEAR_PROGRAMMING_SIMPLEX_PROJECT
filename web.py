...
if __name__ == "__main__":
    ...
    with user_guide_tab:
        ...
        st.write("2. Enter the objective function (the signs and the coefficients must be seperated by a space) as the same as the example:")
        st.image("images/section_2.png", width=650)
        st.write("3. Enter the constraints (the signs and the coefficients must be seperated by a space) as the same as the example:")
        st.image("images/section_3.png", width=650)
        st.write("4. Enter the range constraints (the signs and the coefficients must be seperated by a space) as the same as the example:")
